        ...
        <div class="row flex-grow-1">
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline">
                  <h6 class="card-title mb-0">Total Number of Authors</h6>
          ...
          <div class="col-md-4 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline">
                  <h6 class="card-title mb-0">Personal Ebooks Completed</h6>
                  <div class="dropdown mb-2">
                ...
                <div class="row">
                  <div class="col-6 col-md-12 col-xl-5">
                    <h2 class="mb-2">{{ $completedPeBookData }}</h2>
                    <div class="d-flex align-items-baseline">
                      <p class="text-success">
                        <span>-2.8%</span>
          ...
          <div class="col-md-4 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline">
                  <h6 class="card-title mb-0">Co-author Ebooks Completed</h6>
                  <div class="dropdown mb-2">
                ...
                <div class="row">
                  <div class="col-6 col-md-12 col-xl-5">
                    <h2 class="mb-2">{{ $completedCoBookData }}</h2>
                    <div class="d-flex align-items-baseline">
                      <p class="text-success">
                        <span>+2.8%</span>
                        <i data-feather="arrow-up" class="icon-sm mb-1"></i>
