                  ...
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <form class="forms-sample" method="post" action="{{ route('login') }}">
                      ...
                      <div class="mb-3">
                          ...
                          <input type="text" name="login" class="form-control" id="login" required placeholder="Username/Email">
                          @error('login')
                      ...
                      <div class="mb-3">
                          ...
                          <span style="float:right">
                              <a href="{{ route('user.forget.password') }}" class="mt-3 text">Forgot Password?</a>
                          </span>
