...
<div class="page-content">
  ...
  <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
      <div>
        <h4 class="mb-3 mb-md-0">Personal EBooks In Progress</h4>
      </div>
  </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form class="forms-sample" method="POST" action="{{ route('author.add.book') }}" enctype="multipart/form-data">
                      @csrf
                      <div class="mb-3">
                  ...
                  <td>
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton7">
                            <a class="dropdown-item d-flex align-items-center" href="{{ url('author/edit/book/' .$value->id) }}">
                              <i data-feather="edit" class="icon-sm me-2"></i> 
                              <span class="">Edit Details</span>
                            </a>
                            <a class="dropdown-item d-flex align-items-center" href="{{ url('author/edit/book/content/' .$value->id) }}">
                              <i data-feather="edit" class="icon-sm me-2"></i> 
                              <span class="">Edit Content</span>
                            </a>
                            <a class="dropdown-item d-flex align-items-center" href="{{ url('author/delete/book/' .$value->id) }}" 
                              onclick="confirmation(e)">
