              ...
              <div class="aside-content">
                ...
                <div class="aside-body">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" id="chats-tab" data-bs-toggle="tab" data-bs-target="#chats" role="tab" aria-controls="chats" aria-selected="true">
                        <div class="d-flex flex-row flex-lg-column flex-xl-row align-items-center justify-content-center">
                          ...
                          <p class="d-none d-sm-block">Recent chats</p>
                        </div>
                      </a>
                    </li>
                  </ul>
                  <div class="tab-content mt-3">
                              ...
                              <div class="d-flex justify-content-between align-items-center pb-2 mb-2">
                                ...
                                <div class="dropdown">
                                  <button class="btn p-0" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-settings icon-lg text-muted pb-3px" data-bs-toggle="tooltip" title="" data-bs-original-title="Settings" aria-label="Settings"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg>
                                  </button>
                    ...
                    <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 295px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 126px;"></div></div></div>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="test">
                      <figure class="mb-0 me-2">
                        <img class="img-sm rounded-circle" src="{{ (!empty($profileData->photo)) ? 
                          url('upload/author_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" 
                          alt="profile">
                        <p class="test1">{{ $profileData->name }}</p>
                        <p class="text-muted tx-13 test2">{{ $profileData->email }}</p>
                      </figure>
                    </div>
                  </div>
                </div>
              ...
              <div class="chat-body">
                <ul class="messages">
                  ...
                  <li class="message-item me">
                    <img src="{{ url('upload/ai.png')  }}" class="img-xs rounded-circle" alt="avatar">
                    <div class="content">
                      <div class="message">
                        <div class="bubble">
