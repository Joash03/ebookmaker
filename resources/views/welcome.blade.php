      ...
      <section class="section about" id="about">
        <div class="container">
          ...
          <figure class="about-banner">
            <img src="{{ asset('home/assets/images/about-banner.png') }}" width="700" height="532" loading="lazy" alt="about banner"
              class="w-100 banner-animation">
          </figure>
      ...
      <section class="section features" id="features">
        <div class="container">
          ...
          <figure class="features-banner">
            <img src="{{ asset('home/assets/images/feautres-banner.png') }}" width="369" height="318" loading="lazy" alt="Features Banner"
              class="w-100 banner-animation">
          </figure>
          ...
          <ul class="blog-list">
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="banner">
                  <a href="#">
                    <img src="{{ asset('home/assets/images/blog-1.jpg') }}" width="750" height="350" loading="lazy"
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="banner">
                  <a href="#">
                    <img src="{{ asset('home/assets/images/blog-2.jpg') }}" width="750" height="350" loading="lazy"
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="banner">
                  <a href="#">
                    <img src="{{ asset('home/assets/images/blog-3.jpg') }}" width="750" height="350" loading="lazy"
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="banner">
                  <a href="#">
                    <img src="{{ asset('home/assets/images/blog-4.jpg') }}" width="750" height="350" loading="lazy"
